...
require (
	github.com/ncobase/ncore/data/elasticsearch v0.2.2
	github.com/ncobase/ncore/data/kafka v0.2.2
	github.com/ncobase/ncore/data/meilisearch v0.2.2
	github.com/ncobase/ncore/data/mongodb v0.2.2
	github.com/ncobase/ncore/data/mysql v0.2.2
	github.com/ncobase/ncore/data/neo4j v0.2.2
	github.com/ncobase/ncore/data/opensearch v0.2.2
