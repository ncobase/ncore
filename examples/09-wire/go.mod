module github.com/ncobase/ncore/examples/09-wire
...
require (
	...
	github.com/ncobase/ncore/data/sqlite v0.2.2
...
require (
	...
	github.com/ncobase/ncore/messaging v0.2.2 // indirect
	github.com/ncobase/ncore/net v0.2.2 // indirect
